...
(function() {
    ...
    $(document).ready(function(){
        $('.carousel').slick({
            ...
            draggable: false,       //disables mousedrag to slide
            swipe: false,           //diables swipe to slide
            touchMove: false,       //disables touch to slide
            fade: true,             //enables fade transition
            pauseOnHover: false,    //diables pause of slider on mouse hover
